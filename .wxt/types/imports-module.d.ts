...
declare module '#imports' {
  ...
  export { ChipGroup } from '../src/components/ChipGroup';
  export { UsernameForm } from '../src/components/UsernameForm';
  export { ChipOption, ChipOption } from '../src/utils/ChipOption';
  export { SetClipboardValue } from '../src/utils/ClipboardManager';
  export { Selectable } from '../src/utils/Selectable';
  export { darkTheme } from '../src/utils/Theme';
  export { GetUsername, StoreUsername, ClearUsername, ValidateUsername } from '../src/utils/UsernameManager';
}
